...
export const initialDependentsV3: DependentDetailV3[] = [
  {
    ...
    employee: {
      ...
      identityNumber: "079090001122",
      taxCode: "8090001122",
    },
    fullName: "Nguyễn Minh Khôi",
    dateOfBirth: "2018-05-12",
    identityNumber: "079218009123",
    taxCode: "8021800912",
    relationship: {
      code: "CON_RUOT_NUOI",
      name: "Con ruột / Con nuôi hợp pháp",
    ...
    documents: [
      {
        ...
        documentTypeName: "Bản sao Giấy khai sinh",
        fileName: "Giay_Khai_Sinh_NguyenMinhKhoi.pdf",
        fileSize: 1450000,
        fileUrl: "https://example.com/docs/gks-101.pdf",
        uploadedAt: "2023-01-10T08:30:00Z",
      ...
      },
      {
        ...
        dependentId: 101,
        documentType: "CCCD",
        documentTypeName: "Bản sao CCCD / Hộ chiếu (2 mặt)",
        fileName: "CCCD_NguyenMinhKhoi_2Mat.jpg",
        fileSize: 890000,
        fileUrl: "https://example.com/docs/cccd-101.jpg",
        uploadedAt: "2023-01-10T08:32:00Z",
        uploadedBy: "Nguyễn Văn An",
      },
    ],
    confirmedAt: "2023-01-12T14:00:00Z",
    confirmedBy: { id: 12, fullName: "Trần Thu Trang", roleName: "Kế toán tiền lương" },
    approvedAt: "2023-01-15T09:00:00Z",
    ...
    documents: [
      {
        ...
        documentType: "GIAY_KHAI_SINH",
        documentTypeName: "Bản sao Giấy khai sinh",
        fileName: "GKS_NguyenHaMy.pdf",
        fileSize: 1200000,
        fileUrl: "https://example.com/docs/gks-102.pdf",
        uploadedAt: "2024-06-01T10:15:00Z",
        uploadedBy: "Nguyễn Văn An",
      },
    ],
    confirmedAt: "2024-06-03T11:20:00Z",
    confirmedBy: { id: 12, fullName: "Trần Thu Trang", roleName: "Kế toán tiền lương" },
  ...
  },
  {
    ...
    employee: {
      ...
      project: { projectId: 1017, projectCode: "JSS-ST", projectName: "Jabil Smart Solutions" },
      identityNumber: "079188002345",
      taxCode: "8091880023",
    },
    fullName: "Lê Văn Hùng",
    dateOfBirth: "1956-03-15",
    identityNumber: "079056008899",
    taxCode: "8090560088",
    relationship: {
      code: "CHA_ME_DE",
      name: "Cha đẻ / Mẹ đẻ",
    ...
    documents: [
      {
        ...
        documentType: "CCCD",
        documentTypeName: "Bản sao CCCD / Hộ chiếu (2 mặt)",
        fileName: "CCCD_LeVanHung.jpg",
        fileSize: 2100000,
        fileUrl: "https://example.com/docs/cccd-103.jpg",
  ...
  },
  {
    ...
    employee: {
      ...
      project: { projectId: 1018, projectCode: "KCV-NM", projectName: "Khu Công Viên Nhà Máy" },
      identityNumber: "079192003456",
      taxCode: "8091920034",
    },
    fullName: "Phạm Thị Lan",
    dateOfBirth: "1960-11-08",
    identityNumber: "079060007788",
    taxCode: null,
    relationship: {
      code: "CHA_ME_VO_CHONG",
      name: "Cha mẹ vợ / Cha mẹ chồng",
  ...
  },
  {
    ...
    employee: {
      ...
      project: { projectId: 1018, projectCode: "KCV-NM", projectName: "Khu Công Viên Nhà Máy" },
      identityNumber: "079195004567",
      taxCode: "8091950045",
    },
    fullName: "Phạm Gia Hân",
    dateOfBirth: "2022-04-18",
    identityNumber: "079222001122",
    taxCode: null,
    relationship: {
      code: "CON_RUOT_NUOI",
      name: "Con ruột / Con nuôi hợp pháp",
    ...
    effectiveTo: null,
    status: "REJECTED",
    rejectionReason: "Thiếu bản sao công chứng Giấy khai sinh hợp lệ, ảnh CCCD mờ không đọc được số.",
    canConfirm: false,
    canReject: false,
    canEdit: true,
    documentsCount: 1,
    documents: [
      {
        ...
        documentType: "GIAY_KHAI_SINH",
        documentTypeName: "Bản sao Giấy khai sinh",
        fileName: "GKS_Mo_ChuaDat.jpg",
        fileSize: 450000,
        fileUrl: "https://example.com/docs/gks-105-invalid.jpg",
    ...
    documents: [
      {
        ...
        documentType: "GIAY_KHAI_SINH",
        documentTypeName: "Bản sao Giấy khai sinh",
        fileName: "GiayKhaiSinh_NguyenDucAnh.pdf",
        fileSize: 1100000,
        fileUrl: "https://example.com/docs/gks-106.pdf",
        uploadedAt: "2024-01-05T11:00:00Z",
        uploadedBy: "Vũ Thị Hương",
      },
      {
        id: 1007,
        dependentId: 106,
        documentType: "CCCD",
        documentTypeName: "Bản sao CCCD / Hộ chiếu (2 mặt)",
        fileName: "CCCD_DucAnh.png",
        fileSize: 950000,
        fileUrl: "https://example.com/docs/cccd-106.png",
        uploadedAt: "2024-01-05T11:05:00Z",
        uploadedBy: "Vũ Thị Hương",
      },
    ],
    confirmedAt: "2024-01-08T15:00:00Z",
    confirmedBy: { id: 12, fullName: "Trần Thu Trang", roleName: "Kế toán tiền lương" },
  ...
  },
  {
    ...
    employee: {
      ...
      project: { projectId: 1017, projectCode: "JSS-ST", projectName: "Jabil Smart Solutions" },
      identityNumber: "079190006789",
      taxCode: "8091900067",
    },
    fullName: "Trần Thị Tuyết",
    dateOfBirth: "1992-07-14",
    identityNumber: "079192009988",
    taxCode: "8091920099",
    relationship: {
      code: "VO_CHONG",
      name: "Vợ / Chồng",
    ...
    documents: [
      {
        id: 1008,
        dependentId: 107,
        documentType: "DANG_KY_KET_HON",
        documentTypeName: "Bản sao Giấy chứng nhận kết hôn",
        fileName: "GiayKetHon_ManhCuong_ThiTuyet.pdf",
        fileSize: 1850000,
        fileUrl: "https://example.com/docs/gkh-107.pdf",
        uploadedAt: "2026-06-15T09:40:00Z",
        uploadedBy: "Đỗ Mạnh Cường",
      },
    ],
...
export const initialAuditLogsV3: AuditLogV3[] = [
  {
    id: 501,
    eventType: "APPROVED",
    occurredAt: "2026-08-10T09:15:00Z",
    actor: { id: 5, fullName: "Lê Hoàng Quân", roleName: "Trưởng phòng C&B" },
    employee: { employeeCode: "NV-00124", fullName: "Nguyễn Văn An" },
    dependent: { id: 101, fullName: "Nguyễn Minh Khôi" },
    description: "Phê duyệt hồ sơ giảm trừ gia cảnh người phụ thuộc Nguyễn Minh Khôi.",
  },
  {
    id: 502,
    eventType: "CONFIRMED",
    occurredAt: "2026-08-08T14:20:00Z",
    actor: { id: 12, fullName: "Trần Thu Trang", roleName: "Kế toán tiền lương" },
    employee: { employeeCode: "NV-00124", fullName: "Nguyễn Văn An" },
    dependent: { id: 102, fullName: "Nguyễn Hà My" },
    description: "Xác nhận hồ sơ người phụ thuộc Nguyễn Hà My hợp lệ.",
  },
  {
    id: 503,
    eventType: "DOCUMENT_UPLOADED",
    occurredAt: "2026-08-05T11:00:00Z",
    actor: { id: 99, fullName: "Nguyễn Văn An", roleName: "Nhân viên" },
    employee: { employeeCode: "NV-00124", fullName: "Nguyễn Văn An" },
    dependent: { id: 102, fullName: "Nguyễn Hà My" },
    description: "Tải lên tài liệu minh chứng: Bản sao Giấy khai sinh.",
  },
  {
    id: 504,
    eventType: "REJECTED",
    ...
    actor: { id: 12, fullName: "Trần Thu Trang", roleName: "Kế toán tiền lương" },
    employee: { employeeCode: "NV-00127", fullName: "Phạm Quốc Bảo" },
    dependent: { id: 105, fullName: "Phạm Gia Hân" },
    description: "Từ chối hồ sơ người phụ thuộc Phạm Gia Hân. Lý do: Thiếu bản sao công chứng Giấy khai sinh hợp lệ.",
  },
  {
    id: 505,
    eventType: "DECLARED",
    occurredAt: "2026-07-20T16:00:00Z",
    actor: { id: 98, fullName: "Phạm Quốc Bảo", roleName: "Nhân viên" },
    employee: { employeeCode: "NV-00127", fullName: "Phạm Quốc Bảo" },
    dependent: { id: 105, fullName: "Phạm Gia Hân" },
    description: "Khai báo mới thông tin người phụ thuộc Phạm Gia Hân.",
  },
];
